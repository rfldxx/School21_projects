...
Для удобства ручного тестирования была написана программа hand_test.c, которая запускает примеры из файла hand_test.txt (в этом файле расписано более подробно о работе). \
