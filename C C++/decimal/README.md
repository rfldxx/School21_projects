...
Для удобства ручного тестирования была написана программа hand_test.c, которая запускает примеры из файла hand_test.txt (в этом файле расписано более подробнее о работе). \
Чтобы её вызвать, надо прописать: ```make hand```
```
 [24]  //////////////////////////////////////////////////////////////////////////////////////////
       ///    operation      /
       //////////////////////////////////////////////////////////////////////////////////////////
       ///    init:
       ///       decimal: +                      39614081257132168796771975163  (pow 0) (sign 1)
       ///       decimal: +                     7.9228162514264337593543950327  (pow 28) (sign 1)
       ///
       ///    result:   0
       ///       decimal: +                     4999999999999999999999999999.9  (pow 1) (sign 1)
       ///
       //////////////////////////////////////////////////////////////////////////////////////////

Действительно:     396.. / 7.92..  =  4999999999999999999999999999.93..
Что, округляясь в тип decimal, даст:  4999999999999999999999999999.9
```

Если что это не мой Makefile и кринж-гугл-тесты я тоже спер, немного убрав повторений с помощью макросов.
...
3. [Requirements](#реализация-функции-библиотеки-decimalh)  
