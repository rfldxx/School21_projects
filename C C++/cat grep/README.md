...
Реализован cat/grep (кажется с небольшими улучшениями, касательно вывода). \
Для поиска регулярных выражений использовалась библиотека #include <regex.h>

Тесты не мои (автор уважаемый человек odi****s).
